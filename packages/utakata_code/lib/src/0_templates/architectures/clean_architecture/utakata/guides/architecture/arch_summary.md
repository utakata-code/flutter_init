...
> 詳細なガイドは `AI/guides/architectures/clean_architecture/lib/` を参照してください。
...
- 各層の実装ルール: `AI/guides/architectures/clean_architecture/lib/`
- ディレクトリ構造・命名規則の完全版: `AI/guides/architectures/clean_architecture/directory_structure_and_naming_rules.md`
- 推奨パッケージ: `AI/guides/architectures/clean_architecture/dependencies/`
