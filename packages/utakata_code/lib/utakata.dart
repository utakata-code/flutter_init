...
export 'src/1_domain/1_entities/config/utakata_config_entity.dart';
export 'src/1_domain/1_entities/record/record_id.dart';
export 'src/1_domain/1_entities/record/log_entry.dart';
export 'src/1_domain/1_entities/record/agreement.dart';
export 'src/1_domain/1_entities/record/impl_plan_meta.dart';
...
export 'src/1_domain/2_repositories/config_repository.dart';
